...
# 두 색상 이름 간의 RGB 공간에서의 유클리드 거리를 계산
    ...
    if rgb1 is None or rgb2 is None:
        # 맵에 없는 색상이면 최대 거리를 반환하여 유사도를 0으로
...
# 인식된 색상과 DB의 색상 간의 유사도 점수를 계산. 점수는 0 (완전 다름) 에서 1 (완전 같음) 사이의 값.
...
# 데이터베이스의 약 정보와 분석된 정보를 비교하여 유사도 점수를 계산
    ...
    if imprint_recognized:
        ...
        if db_imprint_full:
            ...
            # 0~100점 스케일의 유사도를 0~MAX_IMPRINT_SCORE 스케일로 변환
