...
# 컬러 이미지의 명암 대비를 먼저 극대화한 뒤, Blackhat과 형태학적 연산으로 노이즈가 없는 깨끗한 각인 이미지를 생성
    ...
    # 색상 반전 (Tesseract가 선호하는 흰 배경, 검은 글씨)
